...
<h1>Mettre à jour les informations de l'enseignant</h1>
</section>
...
<div class="container">
    <form action="save.php" method="post">
      ...
      <label class="form-label" for="nom" style="font-weight: bold; font-size: 1.2em;">Nom :</label>
        <input class="form-control" type="text" name="nom" value="<?= $enseignant ? $enseignant->getNom() : '' ?>" placeholder="Nom de l'enseignant" required>
        </div> 
        <div class="mb-3">
        <label class="form-label" for="prenom" style="font-weight: bold; font-size: 1.2em;">Prénom :</label>
        <input class="form-control" type="text" name="prenom" value="<?= $enseignant ? $enseignant->getPrenom() : '' ?>" placeholder="Prénom de l'enseignant" required>
        </div> 
        <div class="mb-3">
        <label class="form-label" for="contact" style="font-weight: bold; font-size: 1.2em;">Contact :</label>
        <input class="form-control" type="text" name="contact" value="<?= $enseignant ? $enseignant->getContact() : '' ?>" placeholder="Contact de l'enseignant" required>
        </div> 
